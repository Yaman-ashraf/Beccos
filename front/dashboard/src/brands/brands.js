  ...
  const result = brands
    .map(
      (ele) => `
        ...
        <svg onclick="deleteBrand('${ele._id}',event)" xmlns="http://www.w3.org/2000/svg" height="20" width="17.5"
...
const updateBrand = async (e) => {
  ...
  formData.append("name", elements["name"].value);
  formData.append("image", elements["image"].files[0]);
  console.log(elements["image"].files[0]);
...
const editItem = async () => {
  ...
  console.log(brand);
  document.getElementsByName("name")[0].value = brand.name;
